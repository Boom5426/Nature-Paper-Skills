...
- [`figure-style`](../figure-style/SKILL.md): correctness and legibility rules for a single standalone plot.
- [`figure-planner`](../../core/figure-planner/SKILL.md): figure planning, one claim per figure, panel roles, main vs supplement.
- [`scientific-writing`](../../core/scientific-writing/SKILL.md): manuscript prose that the figures support.
